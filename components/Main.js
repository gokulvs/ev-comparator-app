    ...
    const renderCard = (item) => {
        return (
            ...
            <a href="#" className="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
                ...
                <img className="absolute inset-0 h-full w-full object-cover" src={`${item.img}`} alt=""/>
                </div>
                <div className="p-4">
                ...
                <div className="mt-3 flex items-center">
                    <span className="text-sm font-semibold">Rs</span>&nbsp;<span className="font-bold text-xl">45,00</span>&nbsp;<span className="text-sm font-semibold">₹</span>
                </div>
                </div>
